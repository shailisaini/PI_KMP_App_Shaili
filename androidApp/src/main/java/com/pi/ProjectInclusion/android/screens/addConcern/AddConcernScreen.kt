package com.pi.ProjectInclusion.android.screens.addConcern
...
import com.pi.ProjectInclusion.android.screens.screeningScreen.ScreeningIntroDialog
import com.pi.ProjectInclusion.android.utils.fontMedium
import com.pi.ProjectInclusion.android.utils.fontRegular
import com.pi.ProjectInclusion.constants.BackHandler

@Composable
fun AddConcernScreen(onNext: () -> Unit, onBack: () -> Unit) {

    logger.d("Screen: " + "AdvanceScreeningScreen()")
            ...
            Column(
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        items(questionListData) { questionData ->
                            AddConcernActivity(questionData)
                        }
                    }
                }
                ...
                Box(
                    ...
                    Column(
                        ...
                        SmallBtnUi(
                            enabled = true, title = stringResource(R.string.txt_submit_and_conti), onClick = {
                                onNext()
                            })
                    }
                }
...
@Composable
fun AddConcernActivity(questionData: AdvanceScreeningQuestionData) {
...
data class AdvanceScreeningQuestionData(
    var queNumber: Int,
    var question: String,
    var ansYes: String,
    var ansNo: String,
...
fun AdvanceScreeningPreview() {
    val onNext: () -> Unit = {}
    val onBack: () -> Unit = {}
    AddConcernScreen(onNext, onBack)
}