...
@Composable
fun LMSCourseHomeScreen() {

    var strLMSUrl: String =
        "https://lms.projectinclusion.in/?userid=270&partenrsource=partner&langname=english&langid=1"
...
fun LMSCourseHomeScreenPreview() {
    LMSCourseHomeScreen()
}