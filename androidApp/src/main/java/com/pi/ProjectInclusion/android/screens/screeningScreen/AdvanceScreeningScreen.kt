...
@Composable
fun AdvanceScreeningScreen(onNext: () -> Unit, onBack: () -> Unit) {
            ...
            Column(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.txt_35_Question),
                            modifier = Modifier.wrapContentWidth(),
                            fontFamily = fontMedium,
                            fontSize = 14.sp,
                            color = if (isSystemInDarkTheme()) {
...
@Composable
fun AdvanceScreeningQuestionDataUI(questionData: AdvanceScreeningQuestionData) {
